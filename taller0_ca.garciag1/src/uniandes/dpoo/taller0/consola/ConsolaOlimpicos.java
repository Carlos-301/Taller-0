...
public class ConsolaOlimpicos
{
	...
	// Le pide al ususario el nombre de un atleta y retorna su pais
	
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "El pais del atleta seleccionado " + "\n");
		
		String nombre = input("Por favor ingrese el nombre del atleta de interes");
		Pais country = calculadora.buscarPaisAtleta(nombre);
		System.out.println("El pais del atleta indicado es: " + country.darNombre());
	}
